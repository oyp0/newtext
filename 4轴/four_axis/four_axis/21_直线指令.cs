...
namespace four_axis
{
    public partial class _21_直线指令 : Form
    {
        ...
        public _21_直线指令(_20_运动类型选择 F20, _19_文件编辑 F19, _14_文件管理 F14)
        {
            InitializeComponent();
      ...
      //      deal_linesetpos(0);
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            textBox15.Text = linenum.ToString();    //当前行 
            textBox14.Text = filelinepara[0].ToString();   //总行数
            textBox11.Text = codename;
            button10.Text = codename;
        }
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            if (linenum <= filelinepara[0])  //'未新建行时不允许操作
            {
                ...
                {
                    _20_运动类型选择 f20 = new _20_运动类型选择(this.return_19_文件编辑, this.return_14_文件管理,this,null,null,null,null,null,null,null);
                ...
                if (this.return_20_运动类型选择 != null && this.return_19_文件编辑 == null && this.return_14_文件管理 != null)
                {
                    ...
                    _20_运动类型选择 f20 = new _20_运动类型选择(null, this.return_14_文件管理, this, null, null, null, null, null, null, null);
                    f20.g_handle = g_handle;
                    f20.vr = vr;  //数组
                    f20.codespace = codespace; //数组
                    f20.manulradio = manulradio; //速度比例
