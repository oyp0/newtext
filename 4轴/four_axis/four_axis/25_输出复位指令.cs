...
namespace four_axis
{
    public partial class _25_输出复位指令 : Form
    {
        ...
        public _25_输出复位指令(_20_运动类型选择 F20, _19_文件编辑 F19, _14_文件管理 F14)
        {
            InitializeComponent();
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            if (linenum <= filelinepara[0])  //'未新建行时不允许操作
            {
                ...
                {
                    _20_运动类型选择 f20 = new _20_运动类型选择(this.return_19_文件编辑, this.return_14_文件管理,null,null,null,null,this,null,null,null);
                ...
                if (this.return_20_运动类型选择 != null && this.return_19_文件编辑 == null && this.return_14_文件管理 != null)
                {
                    ...
                    _20_运动类型选择 f20 = new _20_运动类型选择(null, this.return_14_文件管理, null, null, null, null, this, null, null, null);
                    f20.g_handle = g_handle;
                    f20.vr = vr;  //数组
                    f20.codespace = codespace; //数组
                    f20.manulradio = manulradio; //速度比例
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            {
                _50未保存提示 f50 = new _50未保存提示(null, null, null, null, null, this.return_14_文件管理, this.return_19_文件编辑, this.return_20_运动类型选择, null, null, null, null,this,null,null,null);
