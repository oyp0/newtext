...
#region "控制器方式回零状态 ZAux_Direct_GetHomeStatus"
/*************************************************************
Description:    //控制器方式回零
Input:          //卡链接handle  
				iaxis	轴号
...
#region "回调函数   ZAux_SetAutoUpCallBack"
/*************************************************************
Description:    //控制器自动上报
Input:          //卡链接	handle 
...
*************************************************************/
#endregion
public delegate void ZAuxCallBack(IntPtr handle, Int32 itypecode, Int32 idatalength, byte[] pdata);
...
#region "IO接口 设置多路输出   ZAux_SetOutMulti"
/*************************************************************
...
#endregion
[DllImport("zauxdll.dll", EntryPoint = "ZAux_SetOutMulti", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
public static extern Int32 ZAux_SetOutMulti(IntPtr handle, UInt16 iofirst, UInt16 ioend,  UInt32[] istate);
